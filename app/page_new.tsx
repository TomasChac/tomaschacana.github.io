  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-100">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-4 mt-4 text-sm text-slate-600">
                ...
                <a href={mailTo} className="flex items-center gap-1 hover:text-blue-600 transition-colors">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-16">
        {/* ABOUT */}
        <section>
          <h2 className="text-2xl font-bold mb-4 border-b-2 border-blue-500 pb-2">Sobre mí</h2>
          <p className="text-slate-700 leading-relaxed text-lg">{resumeData.personal.about}</p>
        </section>

        {/* EDUCATION */}
        <section>
          <h2 className="text-2xl font-bold mb-6 border-b-2 border-blue-500 pb-2">Educación</h2>
        ...
        {/* SKILLS */}
        <section>
          <h2 className="text-2xl font-bold mb-6 border-b-2 border-blue-500 pb-2">Competencias Técnicas</h2>
        ...
        {/* EXPERIENCE */}
        <section>
          <h2 className="text-2xl font-bold mb-6 border-b-2 border-blue-500 pb-2">Experiencia Profesional</h2>
          <div className="space-y-6">
        ...
        {/* PROJECTS */}
        <section>
          <h2 className="text-2xl font-bold mb-6 border-b-2 border-blue-500 pb-2">Proyectos Destacados</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {resumeData.projects.map((project, idx) => (
              ...
              >
                ...
                {project.impact && (
                  <p className="text-xs text-slate-500 italic mb-3 flex-grow">{project.impact}</p>
                )}
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech, i) => (
                    <span key={i} className="px-2.5 py-1 bg-slate-100 text-slate-700 rounded text-xs font-medium">
                      {tech}
                    </span>
                  ))}
                </div>
        ...
        {/* DOCUMENTS */}
        <section>
          <h2 className="text-2xl font-bold mb-6 border-b-2 border-blue-500 pb-2">Documentación Pública</h2>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg p-8 md:p-12 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">¿Interesado en colaborar?</h2>
          <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
            Estoy disponible para prácticas profesionales en sistemas, redes o desarrollo full-stack.
            Contáctame para conversar sobre cómo puedo aportar en tu equipo.
          </p>
      ...
      <footer className="bg-slate-900 text-slate-300 text-center py-6 mt-16">
        <p className="text-sm">© 2024 Tomás Chacana. Construido con Next.js, React y Tailwind CSS.</p>
      </footer>
    </main>
  );
}
